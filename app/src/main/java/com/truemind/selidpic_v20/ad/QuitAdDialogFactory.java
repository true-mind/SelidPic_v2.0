    ...
    private static AlertDialog makeAppCompatDialog(Options options) {
        ...
        if (options.isAdIncluded) {
            if (!options.isRotatable) {
                ...
                applyPadding(dialog, options, activity); // only for AppCompat Dialog
            } else {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                if (parentView instanceof ViewGroup) {
                    ...
                    int padding = activity.getResources().getDimensionPixelSize(
                            R.dimen.quit_dialog_padding);
                    contentWrapper.setPadding(padding, padding, padding, padding);
                }
            }
        });
    }
        ...
        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                if (parentView instanceof ViewGroup) {
                    ...
                    if (options.isAppCompat) {
                        int padding = tempFrameView.getResources().getDimensionPixelSize(
                                R.dimen.quit_dialog_padding);
                        contentWrapper.setPadding(padding, padding, padding, padding);
                    }
